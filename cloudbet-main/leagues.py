TOP_LEAGUES = {
    ...
    'soccer-algeria-ligue-1', 'soccer-armenia-premier-league', 'soccer-bahrain-premier-league',
    'soccer-senegal-premier-league', 'soccer-ethiopia-premier-league',
    'soccer-argentina-copa-argentina', 'soccer-brazil-copa-do-brasil', 'soccer-bolivia-t8ca3-copa-division-profesional',
    'soccer-austria-regionalliga-centre', 'soccer-austria-regionalliga-east',
    'soccer-international-wc-qualifying-conmebol', 'soccer-international-world-cup',
    'soccer-international-clubs-copa-libertadores', 'soccer-international-clubs-copa-sudamericana'
